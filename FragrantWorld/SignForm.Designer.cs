namespace FragrantWorld
{
    partial class SignForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            FWSign_tableLayoutPanel.Margin = new Padding(3, 2, 3, 2);
            ...
            FWSign_tableLayoutPanel.RowStyles.Add(new RowStyle(SizeType.Absolute, 22F));
            FWSign_tableLayoutPanel.RowStyles.Add(new RowStyle(SizeType.Absolute, 22F));
            FWSign_tableLayoutPanel.RowStyles.Add(new RowStyle(SizeType.Absolute, 22F));
            FWSign_tableLayoutPanel.RowStyles.Add(new RowStyle(SizeType.Absolute, 22F));
            FWSign_tableLayoutPanel.RowStyles.Add(new RowStyle(SizeType.Absolute, 22F));
            FWSign_tableLayoutPanel.RowStyles.Add(new RowStyle(SizeType.Absolute, 29F));
            FWSign_tableLayoutPanel.RowStyles.Add(new RowStyle(SizeType.Percent, 50F));
            FWSign_tableLayoutPanel.Size = new Size(700, 338);
            ...
            backButton.Size = new Size(66, 22);
            ...
            sign_LoginLbl.Location = new Point(280, 99);
            sign_LoginLbl.Name = "sign_LoginLbl";
            sign_LoginLbl.Size = new Size(49, 17);
            ...
            sign_LoginTextBox.Location = new Point(280, 123);
            sign_LoginTextBox.Margin = new Padding(3, 2, 3, 2);
            sign_LoginTextBox.MaxLength = 32;
            sign_LoginTextBox.Name = "sign_LoginTextBox";
            sign_LoginTextBox.Size = new Size(172, 24);
            sign_LoginTextBox.TabIndex = 1;
            // 
            // sign_PasswordLbl
            // 
            sign_PasswordLbl.AutoSize = true;
            sign_PasswordLbl.Location = new Point(280, 143);
            sign_PasswordLbl.Name = "sign_PasswordLbl";
            sign_PasswordLbl.Size = new Size(56, 17);
            ...
            sign_PasswordTextBox.Location = new Point(280, 167);
            sign_PasswordTextBox.Margin = new Padding(3, 2, 3, 2);
            sign_PasswordTextBox.Name = "sign_PasswordTextBox";
            sign_PasswordTextBox.Size = new Size(172, 24);
            ...
            sign_ForgotLinkLbl.Location = new Point(280, 187);
            sign_ForgotLinkLbl.Name = "sign_ForgotLinkLbl";
            sign_ForgotLinkLbl.Size = new Size(103, 17);
            ...
            signButton.Location = new Point(280, 211);
            signButton.Margin = new Padding(3, 2, 3, 2);
            signButton.Name = "signButton";
            signButton.Size = new Size(172, 25);
