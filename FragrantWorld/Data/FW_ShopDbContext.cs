...
namespace FragrantWorld.Data;

public partial class FW_ShopDbContext : DbContext
{
    public FW_ShopDbContext()
    {
    }

    public FW_ShopDbContext(DbContextOptions<FW_ShopDbContext> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=.\\MSSQLSERVERHELP;Database=FragrantWorld;Trusted_Connection=True; TrustServerCertificate=True;");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.ManufacturerId).HasName("PK__Manufact__357E5CC18BF8B12B");
        ...
        {
            entity.HasKey(e => new { e.OrderProductId, e.ProductArticleNumber }).HasName("PK__OrderPro__6B5A640F17C13E2F");
        ...
        modelBuilder.Entity<Product>(entity =>
        {
            ...
            entity.HasOne(d => d.ProductCategory).WithMany(p => p.Products)
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__Product__Product__25518C17");

            entity.HasOne(d => d.ProductManufacturer).WithMany(p => p.Products)
                .HasForeignKey(d => d.ProductManufacturerId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__Product__Product__2645B050");
        });

        modelBuilder.Entity<ProductCategory>(entity =>
        {
            entity.HasKey(e => e.CategoryId).HasName("PK__ProductC__19093A0BDAC4A842");
